...
import pandas as pd
"""
    Tách dữ liệu và gán id cho từng lớp
"""
dataset = {
    'ag': None,
    'yelp': None,
...
def preprocess(dataset_name, mode):
    """
    dataset_name: AG News (news classification), Yelp (sentiment analysis), 
    DBPedia (Wikipedia article classification), Amazon (sentiment analysis), 
    and Yahoo! Answer (Q&A classification)
